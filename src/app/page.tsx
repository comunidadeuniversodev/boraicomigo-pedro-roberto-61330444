...
export default function Home() {
  return (
    <>
      <main className="flex flex-col min-h-screen bg-defaultBackground justify-center">
        <Image className="mx-auto" src="/hero.png" alt="logo" width={400} height={270} />
        <div className="flex flex-col w-[1024px] shadow-xl bg-white p-4 rounded-2xl box-shadow mx-auto gap-6">
          <div className="flex flex-row items-center justify-between  mx-auto gap-4">
